...
export function calculateLevelScores(
  ...
  // ЗАЩИТА: не показываем результаты, пока тест не пройден полностью
  // Минимум 15 ответов (меньше этого нет смысла делать диагноз)
  // В реальности адаптивный тест требует 23+ вопроса (6+12+5)
